...
Some nifty functionality is supplied with the assets:
	@var $this->Html->script('/batch/js/batch')@
...
# security:				Adds form buttons to the SecurityComponent::ignoreFields attribute. Resolves conflicts with security component
